...
import home.utils.annotation.Level.HostAuthentication;
import home.utils.annotation.Level.RenterAuthentication;
...
public class AuthenticationInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object object) throws Exception {
        ...
        if (method.isAnnotationPresent(UserLoginToken.class)) {
            ...
            if(method.isAnnotationPresent(RenterAuthentication.class)){
                if(user.getIsOwner().equals("租客")) return true;
                throw new RuntimeException("您无权限访问");
            }
